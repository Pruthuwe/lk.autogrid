    ...
    <>
      ...
      <footer className="footer style-1">
        <div className="te-footer-bg">
          ...
          />
          <img
            src="../../images/section-bg/footer-bg-one.jpg"
            alt="footer image"
          />
        </div>
              ...
              <div className="col-xl-3 col-lg-6 col-md-6">
                <div className="te-footer-widget">
                  <div className="te-footer-widget-info">
                    ...
                    <p>
                      AutoGrid is a leading automobile service provider in
                      Kottawa. We offer a wide range of services to keep your
                  ...
                  <div className="te-footer-widget-info">
                    ...
                    <div className="single-info-wrapper">
                      <div className="single-info">
                        ...
                        <span className="text">+91 12 844 722</span>
                      </div>
                      <div className="single-info">
                        <span className="title">Email</span>
                        <span className="text">info@autogrid.lk</span>
                      </div>
                      <div className="single-info">
